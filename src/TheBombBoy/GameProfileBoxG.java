...
public class GameProfileBoxG {
	InGame ingame;
	GameProfileBoxG(InGame ingame){
		this.ingame = ingame;
	}
	...
	public Image makeProfile() {
		...
		if(ingame.InformationId != null) {
			Font ProfileBoxFont2 = new Font("Arial", Font.BOLD, 40);
			g.setFont(ProfileBoxFont2);
			g.drawString(ingame.InformationAlias, 525, 60);
			g.drawString(ingame.InformationName, 175, 55);
			g.setFont(ProfileBoxFont2);
			g.setColor(Color.BLUE);
			g.drawString(ingame.InformationLevel+"", 782, 55);
		}
